 ...
 * 
 * Login info modiied by Dylan Kramis.
 */
...
var host = "35.247.2.76";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "$499CakeCheese";  //password (change to match your db, yes this is very poor practice)
